...
//		addfx(str, new AddDelay(750.0, 1.0, 0.7));
		...
		Rhythm saxr = r(
				...
				s(6,0.930,79), s(7,0.4,90), s(7.363,0.501,99),
		...
		Rhythm stringr = r(
				s(0.000,3.970,85), s(0.044,3.835,90), s(3.922,3.746,79), s(3.995,3.491,96),
				s(7.706,3.825,81), s(7.790,3.862,75), s(11.608,4.033,78), s(11.647,4.086,74),
				s(15.573,4.024,74), s(15.864,3.679,73), s(19.619,4.210,76), s(19.662,4.075,96),
				s(23.734,3.914,93), s(23.970,7.482,74), s(27.707,3.763,96), s(31.681,4.024,99),
				s(31.718,3.365,87), s(31.795,3.922,78), s(36.026,3.328,99), s(36.151,3.217,73),
				s(39.738,3.993,79), s(39.756,4.059,90), s(43.800,4.011,78), s(43.809,4.064,85),
				s(47.762,4.102,73), s(47.947,3.640,73), s(51.762,4.153,78), s(51.785,3.922,106),
				s(55.816,3.641,99), s(55.892,3.619,76), s(59.725,4.068,106), s(59.783,4.017,99));
		Melody stringm = m(
				an(57), an(60), an(59), an(55),
				an(60), an(57), an(62), an(55),
				an(57), an(60), an(59), an(55),
				an(57), an(60), an(53), an(52),
				an(57), an(60), an(55), an(59),
				an(60), an(57), an(62), an(55),
				an(57), an(60), an(59), an(55),
				an(57), an(60), an(52), an(60));
