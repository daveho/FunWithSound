...
import io.github.daveho.funwithsound.SampleRange;
...
public class LinuxTechno2 extends DemoBase {
	@Override
	public void create() {
		tempo(210, 8);
		
		// Custom sample player using WeirdSampleBankUGen
		Instrument sp = custom(0);
...
/*40*/	add1(gf(boomf));
	...
	public static void main(String[] args) throws MidiUnavailableException, IOException {
		LinuxTechno2 demo = new LinuxTechno2();
		demo.create();
